...
const StudentGallery = () => {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute bottom-0 left-0 w-56 h-56 rounded-full blur-3xl opacity-10 pointer-events-none"
        style={{
          background: `radial-gradient(circle, ${BRAND_MID}, transparent)`,
        }}
      />
      ...
      <div className="lg:w-3/4 w-11/12 mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-500 text-sm mt-2 max-w-md mx-auto">
            Meet the faces behind our growing Qira'at community
          </p>
        </motion.div>
